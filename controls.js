...
function addBtnHome() {
  ...
  if (referrer.indexOf("https://6xgamez54z5zs.com/") !== -1) {
    ...
    e.innerHTML = `
      ...
      <img src="https://ubggames.com/library/ubggames.png" width="140px" height="45px" alt="UnbannedGames">`;
    ...
    e.innerHTML = `
      ...
      <img src="https://ubggames.com/library//ubggames.png" width="13px" height="36px" alt="UnbannedGames">`;
